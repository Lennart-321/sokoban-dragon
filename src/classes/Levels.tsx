...
export class Levels {
    static levels: number[][][] = [
        ...
        [
            ...
            [0, 8, 8, 8, 8, 8, 8, 8, 0, 0, 0, 8, 8],
            [8, 8, 0, 8, 0, 1, 8, 8, 0, 2, 2, 0, 8],
            [8, 0, 0, 0, 0, 2, 0, 0, 0, 0, 0, 0, 8],
            [8, 0, 0, 2, 0, 0, 8, 8, 8, 0, 0, 0, 8],
            [8, 8, 8, 0, 8, 8, 8, 8, 8, 2, 8, 8, 8],
            [8, 0, 2, 0, 0, 8, 8, 8, 0, 4, 4, 8, 0],
            [8, 0, 2, 0, 2, 0, 2, 0, 4, 4, 4, 8, 0],
            [8, 0, 0, 0, 0, 8, 8, 8, 4, 4, 4, 8, 0],
            [8, 0, 2, 2, 0, 8, 0, 8, 4, 4, 4, 8, 0],
            [8, 0, 0, 8, 8, 8, 0, 8, 8, 8, 8, 8, 0],
